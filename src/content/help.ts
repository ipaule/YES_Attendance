...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "샬롬 → 재적 이동: 상태가 '졸업'이어야 이동 버튼이 활성화됩니다. 이동하면 미등록자 리스트로 들어갑니다. 이미 이동했거나 재적에 동명이인이 있으면 다시 이동할 수 없습니다.",
    ],
  },
];
...
export const FAQ: FaqItem[] = [
  ...
  { id: "c3", roles: LEADERSHIP, question: "새 순을 만들었는데 날짜가 이미 있어요 / 없어요.", answer: "사랑·소망·믿음 공동체의 순은 만들 때 기존 공용 날짜를 자동으로 복사합니다. 샬롬 등 다른 공동체는 복사되지 않습니다." },
  ...
  { id: "f5", roles: LEADERSHIP, question: "'새로운 텀 시작'은 뭘 지우나요?", answer: "사랑·소망·믿음의 순·순원·출석·날짜를 기록으로 저장한 뒤 삭제하고, 순장 계정도 삭제합니다. 3단계 확인을 거칩니다." },
  // G. 저장
